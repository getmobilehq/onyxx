-- Complete the data migration after adding missing columns
...
BEGIN
    ...
    LOOP
        ...
        SET 
            ...
            immediate_repair_cost = total_repair_cost * 0.3,
            short_term_repair_cost = total_repair_cost * 0.4,
            long_term_repair_cost = total_repair_cost * 0.3,
...
BEGIN
    ...
    RAISE NOTICE 'Average FCI Score: %', COALESCE(avg_fci, 0);
    RAISE NOTICE '================================';
