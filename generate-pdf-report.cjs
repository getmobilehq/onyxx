...
async function generatePDFReport() {
  ...
  try {
    // Use the report data from our previous successful generation
    console.log('📊 Using report data from previous generation...');
    ...
    console.error('❌ Error generating PDF report:', error.response?.data || error.message);
